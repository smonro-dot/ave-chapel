...
import { Shell } from "@/components/ave/shell";
  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0b0a0c" },
      {
        name: "description",
        content:
          "Pray the Rosary bead by bead, read Gospel stories with your child, and search the saints — a Catholic home for a father and son.",
      },
    ],
    links: [
